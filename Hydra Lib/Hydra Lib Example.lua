local UILib = loadstring(game:HttpGet('https://raw.githubusercontent.com/Redyoffc/Roblox-UI-Libraries/refs/heads/UI-Libraries/Hydra%20Lib/Hydra%20Lib%20Source.lua'))()
